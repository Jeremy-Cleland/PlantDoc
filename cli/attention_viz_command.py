...
def visualize(
    model_name: str = typer.Option(
        ..., "--model", "-m", help="Model name to visualize"
    ),
    ...
    try:
        ...
        preprocess = transforms.Compose([
            transforms.Resize((cfg.preprocessing.resize[0], cfg.preprocessing.resize[1])),
            transforms.CenterCrop((cfg.preprocessing.center_crop[0], cfg.preprocessing.center_crop[1])),
            transforms.ToTensor(),
